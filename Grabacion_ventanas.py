...
class Pruebas_retail(unittest.TestCase):
    """
    Clase de pruebas automatizadas para evaluar tiempos de carga y funcionalidad en sitios
    de retail utilizando Selenium y FFmpeg.
    
    Atributos:
    - CHROME_DRIVER_PATH (str): Ruta del driver de Chrome.
    - output_folder (str): Carpeta de salida para los videos. 
    - CREDENTIALS (dict): Diccionario con credenciales de acceso.
    - urls (list): Lista de URLs de sitios de retail.
    - FFmpeg_COMMANDS (list): Lista de procesos FFmpeg en ejecución.
    ...
    def setUpClass(cls):
        ...
        Funcionalidad:
        - Configura los navegadores con las opciones necesarias.
        - Crea archivos de reporte para almacenar los tiempos de carga.
        - Inicializa los navegadores y obtiene los identificadores de ventana.
        - Genera archivos auxiliares para superposición de texto en grabaciones.
        - Crea carpetas donde se almacenarán los videos.
        ...
        #Reportes
        # Archivo de log de tiempos y texto para overlay en FFmpeg
        cls.log_file = os.path.join(cls.output_folder, f"Reporte_Tiempos_Carga_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
    ...
    def grabar_multiples_ventanas(self, ventana_idx=0):
        ...
        Parámetros:
        - ventana_idx (int): Índice de la ventana a grabar.
        
        Funcionalidad:
        - Obtiene el identificador de la ventana a grabar.
        - Genera el nombre del archivo de salida con el título correspondiente.
        - Inicia un hilo para manejar la grabación de la ventana.
    ...
    def iniciar_grabacion(self, hwnd, output_file):
        """
        Configura y ejecuta FFmpega para grabar la pantalla de una ventana específica.
        
        Parámetros:
        - hwnd (int): Identificador de la ventana a grabar.
        - output_file (str): Ruta del archivo de salida para la grabación
        
        Funcionalidad:
        - Usa FFmpeg para capturar la pantalla de la ventana identificada por `hwnd`.
        - Agrega una superposición de texto con el tiempo transcurrido y un texto con las acciones realizadas (`overlay_text_file`.)
        - Configura el formato de video a H.264 con una tasa de bits ajustada para eficiencia.
        - Captura de audio con el códec AAC.
        - La grabación se guarda en la ubicación especificada por `output_file`.
        - Maneja procesos en segundo plano utilizando `subprocess.Popen`.
        
        """
        # Comandos FFmpeg usando `hwnd`
        ffmpeg_cmd = [
            "C:/webm/bin/ffmpeg", # Ruta de ejecución de FFmpeg
        ...
        # Inicia el proceso FFmpeg en segundo plano
    ...
    def detener_grabacion(self, ventana_idx):
        """
        Detiene la grabación de una ventana específica.
        
        Parámetros:
        - ventana_idx (int): índice de la ventana cuya grabación debe detenerse.
        
        Funcionalidad:
        - Verifica si el proceso de grabación existe y lo detiene enviando el comando 'q'.
        """
    ...
    def create_excel_report(cls):
        """
        Crea un archivo de Excel para registrar los tiempos de carga si no existe.
        
        Funcionalidad:
        - Verifica si el archivo ya existe, de lo contrario, lo crea.
        - Agrega encabezados a la hoja de cálculo.
        - Formatea las celdas con color de fondo y negrita
        """
    ...
    def log_performance(self, action_name, start_time, end_time):
        """
        Registra los tiempos de carga de las acciones en el archivo de Excel y en un archivo de texto.
        
        Parámetros:
        - action_name (str): Nombre de la acción registrada.
        - start_time (float): Tiempo de inicio de la acción.
        - end_time (float): Tiempo de la finalización de la acción.
        
        Funcionalidad:
        - Calcula la duración de la acción.
        - Convierte los tiempos a formato legible con horas, minutos y segundos.
        - Escribe los datos en un archivo de Excel y un archivo e texto de logs.
        - Sobreescribe el archivo overlay_text.txt con el tiempo de ejecución para ser utilizado en los videos.
        """
    ...
    def tearDownClass(cls):
        ...
        """
        Cierra los navegadores al finalizar las pruebas.
